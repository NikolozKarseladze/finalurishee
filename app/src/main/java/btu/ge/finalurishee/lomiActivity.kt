...
import btu.ge.finalurishee.databinding.ActivityLomiBinding
import com.google.firebase.database.DataSnapshot
import com.google.firebase.database.DatabaseError
import com.google.firebase.database.FirebaseDatabase
import com.google.firebase.database.ValueEventListener

class lomiActivity : AppCompatActivity() {

    private lateinit var binding: ActivityLomiBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityLomiBinding.inflate(layoutInflater)
    ...
    private fun init() {
        ...
        myRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                if (value != null) {
                    binding.textLomi.text = value.lomii
